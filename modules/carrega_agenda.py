...
# print(hora_atual)
hora_atual, minuto_atual = datetime.datetime.time(
    hora_atual).hour, datetime.datetime.time(hora_atual).minute
...
planilha_agenda = 'C:/Users/Fiala/Desktop/assistente/agenda.xlsx'
